...
import cn.soe.util.Assert;
import cn.soe.util.io.StreamUtils;
...
public abstract class StringUtils {
    ...
    public static String[] toStringArray(Collection<String> collection) {
        return (!CollectUtils.isEmpty(collection) ? collection.toArray(EMPTY_STRING_ARRAY) : EMPTY_STRING_ARRAY);
    }
